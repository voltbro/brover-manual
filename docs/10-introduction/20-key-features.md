...
<figure style={{textAlign: 'center'}}><img src={require("./img/web-interface.png").default} alt="qj" width="800" /></figure>
...
1. Компьютер должен находится в одной Wi-Fi сети с ровером. По умолчанию ровер подключается к сетям:
...
1. Компьютер должен находится в одной Wi-Fi сети с ровером.
...
<figure style={{textAlign: 'center'}}><img src={require("./img/code-server1.png").default} alt="qj" width="800" /></figure>
...
<figure style={{textAlign: 'center'}}><img src={require("./img/code-server2.png").default} alt="qj" width="800" /></figure>

## Расширение функциональности

Ровер поддерживает подключение дополнительных модулей на базе электроники [VBCores](https://vbcores.ru/). Для этого необходимо использовать коммутационную плату. На ней для подключения доступны сигнальная шина **CAN1** и  два силовых разъема XT-30 с выходным напряжением равным входному напряжению на ровер. 
