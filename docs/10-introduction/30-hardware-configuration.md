...
<figure style={{textAlign: 'center'}}><img src={require("./img/vb-canhat-qc-v1_0-3.jpg").default} alt="Сборка Raspberry Pi 5 с CAN-FD HAT и коммутационной платой" width="600" /></figure>
